...
## 对话框和姓名框背景透明度（0.0 完全透明，1.0 完全不透明）。
define gui.textbox_opacity = 0.5
define gui.namebox_opacity = 0.5

## NVL 黑色遮罩强度（0.0 无黑层，1.0 全黑）。
define gui.nvl_window_opacity = 0.7
...
## NVL 模式背景窗口的背景边框。
define gui.nvl_borders = Borders(64, 44, 64, 28)
...
## 所指定叙述角色的标签的坐标、宽度和对齐方式。
define gui.nvl_name_xpos = 80
define gui.nvl_name_ypos = 0
define gui.nvl_name_width = 220
